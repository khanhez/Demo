...
<body>    
	<!-- header -->
	<header id="header" style="background-color: #61d40b">
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a style="color: white;font-size: 30px" href="{{asset('/')}}">TRANG CHỦ</a>			<!-- img/home/logo.png	 -->		
				...
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					...
					<a href="{{asset('cart/show')}}">{{Cart::count()}}</a> <!-- hàm hiển thị ra số lượng -->				    
				</div>
			</div>			
		</div>
	</header><!-- /header -->
	...
	<!-- footer -->
	<footer id="footer">			
		<div id="footer-t" style="background-color: #3fff00">
			<div class="container">
				<div class="row">				
					<div id="logo-f" class="col-md-3 col-sm-12 col-xs-12 text-center">						
						<a href="#"><img src=""></a>		<!-- img/home/logo.png -->
					</div>
			...
			<div id="footer-b" style="background-color: #61d40b">				
				<div class="container">
					<div class="row">
						<div id="footer-b-l" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>Lap trinh web- Laravel</p>
						</div>
